...
public:
	...
	virtual void update(sf::Time dt, NavigationProvider<sf::Vector2i> & navigation, float speedBuff) = 0;
...
public:
	...
	virtual void update(sf::Time dt, NavigationProvider<sf::Vector2i> & navigation, float speedBuff) override;
